            ...
            <div class="content">
                <div class="left">
                    <div class="resultTip">
                        ...
                        首页 <span class="normal">&nbsp;> {{category==1?siteInfo.categorys[0].name:category==2?siteInfo.categorys[1].name:category==3?siteInfo.categorys[2].name:category==4?siteInfo.categorys[3].name:''}}</span>
                    </div>
