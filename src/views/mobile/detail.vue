    ...
    <div class="page">
        ...
        <div class="container">
            <div class="resultTip">
                ...
                首页 ><span>&nbsp;{{category==1?siteInfo.categorys[0].name:category==2?siteInfo.categorys[1].name:category==3?siteInfo.categorys[2].name:category==4?siteInfo.categorys[3].name:''}}</span>
            ...
            <div class="line3">
                <div class="type">
                    <img :class="articleDetail.category_id==1?'img-upper':articleDetail.category_id==2?'img-img':articleDetail.category_id==3?'img-video':articleDetail.category_id==4?'img-year':''"
                         ...
                         alt="">
                    {{articleDetail.category_id==1?siteInfo.categorys[0].name:articleDetail.category_id==2?siteInfo.categorys[1].name:articleDetail.category_id==3?siteInfo.categorys[2].name:articleDetail.category_id==4?siteInfo.categorys[3].name:''}}
                </div>
                <div class="time">
